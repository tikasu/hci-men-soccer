...
import { isSignupEnabled } from '@/lib/services/userService';
...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (signupDisabled) {
      setError('Signup is currently disabled. Please contact an administrator.');
      return;
    }
      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        {signupDisabled && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
            <span className="block sm:inline">Signup is currently disabled. Please contact an administrator for access.</span>
          </div>
        )}
